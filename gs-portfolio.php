 ...
 * Description:       	Best Responsive Portfolio plugin for your Wordpress site. Display anywhere at your site using shortcode like [gs_portfolio] Check more shortcode examples and documention at <a href="http://portfolio.gsamdani.com">GS Portfolio Docs</a> 
 * Version:           	1.0.2
...
function gs_portfolio_add_action_plugin( $actions, $gsp_plugin_file ) 
{
	...
	if ($gsp_plugin == $gsp_plugin_file) {
			...
			$site_link = array('support' => '<a href="http://www.gsamdani.com/support" target="_blank">Support</a>');
			$more_plugin = array('more' => '<a href="http://www.gsamdani.com/wordpress-plugins/" target="_blank">More Plugings</a>');
